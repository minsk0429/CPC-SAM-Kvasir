...
def inference(args, multimask_output, db_config, model, test_save_path=None):
    ...
    # save:
    write_csv = "C:/ai-agent/CPC-SAM-main/output/test_results/" + args.exp + "_test_mean.csv"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str,
                    default='C:/ai-agent/data/Kvasir', help='Name of Experiment')
    parser.add_argument('--config', type=str, default=None, help='The config file provided by the trained model')
    parser.add_argument('--dataset', type=str, default='Kvasir', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=1)
    parser.add_argument('--output_dir', type=str, default='C:/ai-agent/CPC-SAM-main/output/')
    ...
    parser.add_argument('--lora_ckpt', type=str, default=None, help='The checkpoint from LoRA (provide trained model path)')
