...
parser.add_argument('--root_path', type=str,
                    default='C:/ai-agent/data/Kvasir', help='root dir for data')
parser.add_argument('--output', type=str, default='C:/ai-agent/CPC-SAM-main/output')
...
parser.add_argument('--ckpt', type=str, default='C:/ai-agent/CPC-SAM-main/checkpoints/sam_vit_b_01ec64.pth',
...
parser.add_argument('--labeled_num', type=float, default=0.15, help='For ACDC: number of labeled patients (1,3,7,14,21,28,35). For Kvasir: percentage of labeled data (0.05=5%)')  # determine the number of labeled data
parser.add_argument('--warm_iter', type=int, default=5000,help='labeled data') 
parser.add_argument('--method', type=str, default='ssl_dualmask')
...
if __name__ == "__main__":
    ...
    trainer = {'ACDC': trainer_acdc_dualmask_prompt_ssl_fixcoe_random_new_mean_up,
               'Kvasir': trainer_acdc_dualmask_prompt_ssl_fixcoe_random_new_mean_up}  # Use same trainer for Kvasir
